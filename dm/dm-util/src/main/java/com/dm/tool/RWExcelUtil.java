 ...
 * 系统名：NSK-NRDC业务系统
 * 作成人：李辉
 * 模块：Excel文件操作工具类，包括读、写、合并等功能
 */
public class RWExcelUtil {
   ...
   * Excel文件路径
   */
  private String excelPath = "D:/月度工时报表"+new Date().getTime()+".xls";
  ...
  public RWExcelUtil(String excelPath){
   ...
   * @return
   */
  public RWExcelUtil RestoreSettings(){
      RWExcelUtil instance = new  RWExcelUtil(this.excelPath);
      return instance;
  }
  ...
  public static void main(String[] args) {
	  RWExcelUtil eu = new RWExcelUtil();
